    ...
    public static void main(String[] args) {
        ...
        if (scanner.hasNextInt()) {
            ...
            if (escolhaCurso > 0 && escolhaCurso <= cursos.size()) {
                ...
                Log.setLog("O usuário definiu " + professorEscolhido + " como novo coordenador do curso de "
                        + cursoEscolhido);
            } else {
        ...
        System.out.println();
        System.out.println("------Alteração de notas dos estudantes em recuperação------");
        ...
        if (curso1.getCoordenador().getNome().equalsIgnoreCase(nomeCoordenador)) {
            ...
            System.out.println("Nome do coordenador inválido. Acesso Negado!");

        }

        System.out.println();
        System.out.println();
        System.out.println("_____LISTA FINAL APÓS RECUPERAÇÃO____");
        System.out.println();
        for (Estudante estudante : estudantes) {
            System.out.println(estudante.getNome());
            System.out.println("Média: " + estudante.getMedia());
